...
/// Creates the static filter for the given array.
///
/// This preserves the existing dispatch behavior: primitive numeric types use
/// specialized primitive filters, and other types fall back to
/// [`ArrayStaticFilter`].
