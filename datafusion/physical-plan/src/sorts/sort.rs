...
impl SortExec {
    ...
    pub fn with_fetch(&self, fetch: Option<usize>) -> Self {
        ...
        SortExec {
            ...
            sort_prefix: self.sort_prefix.clone(),
            fetch,
            cache,
        }
    }
    ...
    fn compute_properties(
        ...
        let sort_prefix = if sort_satisfied {
            LexRequirement::default()
        } else {
            input
                .equivalence_properties()
                .longest_satisfied_prefix(&requirement)
        };
            ...
            DisplayFormatType::Default | DisplayFormatType::Verbose => {
                ...
                match self.fetch {
                    Some(fetch) => {
                        ...
                        if !self.sort_prefix.is_empty() {
                            write!(f, ", sort_prefix=[{}]", self.sort_prefix)
                        } else {
                            Ok(())
                        }
                    }
